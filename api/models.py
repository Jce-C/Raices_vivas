...
class Product(models.Model):
    ...
    artisan_image = models.URLField(blank=True, null=True, help_text="URL de la foto del artesano")
...
class BlogPost(models.Model):
    ...
    is_recent_post = models.BooleanField(default=False, help_text="Marcar como post reciente para mostrar en la página principal")
    is_featured = models.BooleanField(default=False, help_text="Marcar como destacado para mostrar en homepage")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
