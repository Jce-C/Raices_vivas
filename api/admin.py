...
class BlogPostAdmin(admin.ModelAdmin):
    list_display = ('title', 'author', 'is_published', 'is_recent_post', 'created_at', 'post_preview')
    list_filter = ('is_published', 'is_recent_post', 'created_at', 'author')
    search_fields = ('title', 'content', 'author')
    readonly_fields = ('slug', 'created_at', 'updated_at')
    list_editable = ('is_published', 'is_recent_post')

    fieldsets = (
        ('Información Básica', {
            'fields': ('title', 'slug', 'author', 'is_published', 'is_recent_post')
        }),
        ('Contenido', {
